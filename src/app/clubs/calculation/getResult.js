export function getResult(homePercent, drawPercent, awayPercent, probabilityScoreHomeGoals, probabilityLoseHomeGoals, probabilityScoreAwayGoals, probabilityLoseAwayGoals ){
    ...
    let levelGoals;
    if(worseLoseGoals > 1 && worseLoseGoals < 1.5 && betterScoreGoals > 1 && betterScoreGoals < 1.5) levelGoals = 1;
    else if(worseLoseGoals > 1.5 && betterScoreGoals > 1.5) levelGoals = 3;
    else if(worseLoseGoals > 1.5 || betterScoreGoals > 1.5) levelGoals = 2;
    else levelGoals = 0;
